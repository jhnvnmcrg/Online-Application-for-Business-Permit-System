...
// Configure nodemailer transporter (only if email is enabled)
...
if (EMAIL_ENABLED && EMAIL_USER && EMAIL_PASSWORD) {
  ...
  console.log("ℹ Email notifications disabled (set EMAIL_ENABLED=true to enable)");
}

// Email templates
const emailTemplates = {
  requestSubmitted: (ownerName, trackingCode) => ({
    subject: "Application Submitted Successfully - OABP",
    html: `
      <!DOCTYPE html>
      <html>
      <head>
        <style>
          ...
          .info-box { background-color: white; padding: 15px; border-radius: 5px; margin: 20px 0; border-left: 4px solid #0d6efd; }
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p>Your business permit application has been successfully submitted and is now being processed.</p>
            <div class="info-box">
              <p style="margin: 0;"><strong>Tracking Code:</strong></p>
              <h3 style="margin: 10px 0; color: #0d6efd;">${trackingCode}</h3>
            </div>
            <p>You can use this tracking code to monitor your application status through your dashboard.</p>
            <p>We will notify you once your application has been reviewed.</p>
            <p>Thank you for using our Online Application for Business Permit System.</p>
          </div>
          <div class="footer">
            <p>This is an automated message from OABP System. Please do not reply to this email.</p>
          </div>
        </div>
      </body>
      </html>
  ...
  paymentRequired: (ownerName, trackingCode, amount, deadline) => ({
    subject: "Payment Required for Your Application - OABP",
    html: `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            <p>Dear <strong>${ownerName}</strong>,</p>
            <p>Your business permit application has been reviewed and payment is now required to proceed.</p>
            <div class="info-box">
              <p><strong>Tracking Code:</strong> ${trackingCode}</p>
              <p><strong>Amount Due:</strong> <span class="amount">₱${parseFloat(amount).toLocaleString('en-PH', { minimumFractionDigits: 2 })}</span></p>
              ${deadline ? `<p><strong>Payment Deadline:</strong> ${new Date(deadline).toLocaleDateString('en-PH', { year: 'numeric', month: 'long', day: 'numeric' })}</p>` : ''}
            </div>
            <p>Please submit your payment proof through your dashboard to continue processing your application.</p>
            ${deadline ? `<div class="warning">
              <strong>⚠ Important:</strong> Payment must be submitted before the deadline to avoid delays.
            </div>` : ''}
  ...
  paymentVerified: (ownerName, trackingCode) => ({
    subject: "Payment Verified Successfully - OABP",
    html: `
      <!DOCTYPE html>
      <html>
      <head>
        <style>
          ...
          .content { background-color: #f8f9fa; padding: 30px; }
          .info-box { background-color: white; padding: 15px; border-radius: 5px; margin: 20px 0; border-left: 4px solid #198754; }
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p>We will notify you once your business permit application has been approved.</p>
  ...
  paymentRejected: (ownerName, trackingCode, remarks) => ({
    subject: "Payment Verification Update - OABP",
    html: `
      <!DOCTYPE html>
      <html>
      <head>
        <style>
          ...
          .content { background-color: #f8f9fa; padding: 30px; }
          .info-box { background-color: white; padding: 15px; border-radius: 5px; margin: 20px 0; border-left: 4px solid #dc3545; }
          .remarks-box { background-color: #fff3cd; padding: 15px; border-radius: 5px; margin: 20px 0; }
          .footer { text-align: center; padding: 20px; color: #6c757d; font-size: 12px; }
        </style>
      </head>
      <body>
        <div class="container">
          ...
          <div class="content">
            <p>Dear <strong>${ownerName}</strong>,</p>
            <p>We need your attention regarding your payment submission.</p>
            <div class="info-box">
              <p><strong>Tracking Code:</strong> ${trackingCode}</p>
            </div>
            ${remarks ? `<div class="remarks-box">
              <p><strong>Remarks from Admin:</strong></p>
              <p>${remarks}</p>
            </div>` : ''}
            <p>Please review the remarks above and resubmit your payment proof with the necessary corrections through your dashboard.</p>
  ...
  applicationApproved: (ownerName, trackingCode) => ({
    subject: "Application Approved - Business Permit Ready - OABP",
    html: `
      <!DOCTYPE html>
      <html>
      <head>
        <style>
          ...
          .info-box { background-color: white; padding: 15px; border-radius: 5px; margin: 20px 0; border-left: 4px solid #198754; }
          .success-icon { font-size: 48px; text-align: center; margin: 20px 0; }
          .highlight { background-color: #d1e7dd; padding: 15px; border-radius: 5px; margin: 20px 0; }
          .footer { text-align: center; padding: 20px; color: #6c757d; font-size: 12px; }
        </style>
      </head>
      <body>
        <div class="container">
          ...
          <div class="content">
            <div class="success-icon">✓</div>
            <p>Dear <strong>${ownerName}</strong>,</p>
            <p><strong>Congratulations!</strong> Your business permit application has been approved.</p>
            <div class="info-box">
              <p><strong>Tracking Code:</strong> ${trackingCode}</p>
            </div>
            <div class="highlight">
              <p style="margin: 0;"><strong>Your business permit is now ready for release!</strong></p>
            </div>
            <p>Please check your dashboard for more details and instructions on how to claim your permit.</p>
            <p>Thank you for using our Online Application for Business Permit System!</p>
          </div>
          <div class="footer">
            <p>This is an automated message from OABP System. Please do not reply to this email.</p>
  ...
  applicationRejected: (ownerName, trackingCode, remarks) => ({
    subject: "Application Status Update - OABP",
    html: `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            <p>Dear <strong>${ownerName}</strong>,</p>
            <p>We regret to inform you that your business permit application requires attention and corrections.</p>
            <div class="info-box">
              <p><strong>Tracking Code:</strong> ${trackingCode}</p>
            </div>
            ${remarks ? `<div class="remarks-box">
            ...
            <p>Please review the remarks above and make the necessary corrections. You may resubmit your application through your dashboard.</p>
            <p>If you need clarification or assistance, please contact our office.</p>
          </div>
          <div class="footer">
            <p>This is an automated message from OABP System. Please do not reply to this email.</p>
          </div>
...
// Helper function to send email with comprehensive error handling
const sendEmail = async (to, template) => {
  // Don't attempt to send if email is disabled
  if (!EMAIL_ENABLED) {
    console.log("📧 Email skipped (EMAIL_ENABLED=false):", template.subject);
    return { success: true, skipped: true, message: "Email notifications disabled" };
  }

  // Validate transporter exists
  if (!transporter) {
    console.log("📧 Email skipped (transporter not configured):", template.subject);
    return { success: true, skipped: true, message: "Email transporter not configured" };
  }
  ...
  if (!template || !template.subject || !template.html) {
    console.error("✗ Invalid email template");
  ...
  try {
    ...
    return {
      success: false,
      error: error.message,
      message: "Email send failed but operation continued"
    };
  }
};
  ...
  try {
    ...
    try {
      ...
      if (ownerData?.email) {
        ...
        sendEmail(ownerData.email, emailTemplate).catch(err =>
...
app.put("/api/request/update-status/:requestId", upload.single("attachmentFile"), async (req, res) => {
  try {
    ...
    // Send email notification to business owner for specific status changes (non-blocking)
    try {
      ...
      if (requestDetails?.Owners?.email) {
        ...
        if (emailTemplate) {
          // Fire and forget - don't wait for email to complete
          sendEmail(requestDetails.Owners.email, emailTemplate).catch(err =>
            console.error("Email notification failed:", err)
          );
        }
      }
...
app.post("/api/payment/add", async (req, res) => {
  try {
    ...
    try {
      ...
      if (requestOwner?.Owners?.email) {
        const emailTemplate = emailTemplates.paymentRequired(
          requestOwner.Owners.fullname,
          requestOwner.tracking_code,
          parseFloat(amount),
          calculatedDeadline
        );
        // Fire and forget - don't wait for email to complete
        sendEmail(requestOwner.Owners.email, emailTemplate).catch(err =>
          console.error("Email notification failed:", err)
        );
      }
    } catch (emailError) {
...
app.put("/api/payment/verify/:paymentId", async (req, res) => {
  try {
    ...
    try {
      ...
      if (paymentDetails?.Requests?.Owners?.email) {
        let emailTemplate;
        if (status === "Verified") {
          emailTemplate = emailTemplates.paymentVerified(
            paymentDetails.Requests.Owners.fullname,
            paymentDetails.Requests.tracking_code
          );
        } else {
        ...
        // Fire and forget - don't wait for email to complete
        sendEmail(paymentDetails.Requests.Owners.email, emailTemplate).catch(err =>
          console.error("Email notification failed:", err)
        );
      }
    } catch (emailError) {
